...
class AnimPainter extends CustomPainter {
  ...
  AnimPainter(this.points, {this.showRound = false}) : super(repaint: points);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    textPainter.text = const TextSpan(
        text: '动画控制器数值散点图', style: TextStyle(fontSize: 14, color: Colors.black,fontWeight: FontWeight.bold));
  ...
  void _drawScale(Canvas canvas, Size size) {
    ...
    //圆球
    if(points.values.isNotEmpty && showRound){
